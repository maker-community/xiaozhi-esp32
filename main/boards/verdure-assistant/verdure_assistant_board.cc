/**
 * @file verdure_assistant_board.cc
 * @brief 绿荫搭子 (Verdure Assistant) 开发板实现
 * @see https://oshwhub.com/greenshade/verdure-assistant
 * 
 * 基于立创·实战派 ESP32-S3 开发板代码修改
 */
...
#define TAG "VerdureAssistantBoard"
...
class VerdureAssistantBoard : public WifiBoard {
private:
...
public:
    VerdureAssistantBoard() : boot_button_(BOOT_BUTTON_GPIO) {
        InitializeI2c();
        InitializeSpi();
