...
public:
    ...
    bool IsSignalRAudioPlaying() const { return signalr_audio_playing_; }
...
private:
    ...
    bool signalr_audio_playing_ = false;  // Flag to indicate if SignalR audio is currently playing
    int clock_ticks_ = 0;
